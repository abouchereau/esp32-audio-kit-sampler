...
// ==== ES8388 en I2C sur 33/32 (validé aussi) ====
ES8388 es(33, 32, 400000);

// ==== I2S config (fonctionnelle !) ====
...
void setup() {
  ...
  es.outputSelect(OUT2); // casque es.setOutputVolume(80); // volume raisonnable
